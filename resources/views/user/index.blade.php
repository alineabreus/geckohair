                ...
                @foreach($employees as $employee)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{route('users.edit', $employee->user->id)}}"><i class="fa fa-pencil-alt"></i></a>
                        </td>
                        <td class="text-center">
                            <a style="color:red;" href="{{route('users.delete', $employee->user->email)}}"><i class="fa fa-trash-alt"></i></a>
                        </td>
                    </tr>
                @endforeach
